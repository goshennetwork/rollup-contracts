...
func NewTree(tree_size uint64, hashes []web3.Hash, store HashStore) *CompactMerkleTree {
...
func (self *CompactMerkleTree) _update(tree_size uint64, hashes []web3.Hash) {
...
func (self *CompactMerkleTree) Root() web3.Hash {
...
func (self *CompactMerkleTree) GetRootWithNewLeaf(newLeaf web3.Hash) web3.Hash {
...
func (self *CompactMerkleTree) cloneMem() CompactMerkleTree {
	...
	temp.hashes = make([]web3.Hash, len(self.hashes))
...
func (self *CompactMerkleTree) GetRootWithNewLeaves(newLeaf []web3.Hash) web3.Hash {
	tree := self.cloneMem()
...
func (self *CompactMerkleTree) Append(leafv []byte) []web3.Hash {
...
func (self *CompactMerkleTree) AppendHash(leaf web3.Hash) []web3.Hash {
	...
	auditPath := make([]web3.Hash, size, size)
	storehashes := make([]web3.Hash, 0)
	// reverse
...
func (self *CompactMerkleTree) ConsistencyProof(m, n uint64) []web3.Hash {
...
func (self *CompactMerkleTree) subproof(m, n uint64, b bool) []web3.Hash {
	...
	length := len(hashes)
	reverse := make([]web3.Hash, length, length)
	for k := range reverse {
...
func (self *CompactMerkleTree) InclusionProof(m, n uint64) ([]web3.Hash, error) {
	if m >= n {
...
*/
func (self *MerkleVerifier) VerifyLeafHashInclusion(leaf_hash web3.Hash,
	leaf_index uint64, proof []web3.Hash, root_hash web3.Hash, tree_size uint64) error {
...
func (self *MerkleVerifier) calculate_root_hash_from_audit_path(leaf_hash web3.Hash,
	node_index uint64, audit_path []web3.Hash, tree_size uint64) (web3.Hash, error) {
...
func (self *MerkleVerifier) VerifyConsistency(old_tree_size,
	new_tree_size uint64, old_root, new_root web3.Hash, proof []web3.Hash) error {
	...
	*/
	...
	lenp := len(proof)
	pos := 0
	var new_hash, old_hash web3.Hash
