...
/* Library Imports */
import { Lib_Buffer } from "../libraries/Lib_Buffer.sol";
 ...
 *
 */
contract ChainStorageContainer is IChainStorageContainer, AddressResolver {
    /*************
     * Libraries *
     *************/
     ...
     */
    constructor(address _libAddressManager, string memory _owner) AddressResolver(_libAddressManager) {
        owner = _owner;
    }
    ...
    modifier onlyOwner() {
        require(msg.sender == resolve(owner), "ChainStorageContainer: Function can only be called by the owner.");
        _;
    }
     ...
     */
    // slither-disable-next-line external-function
    function deleteElementsAfterInclusive(uint256 _index, bytes27 _globalMetadata) public onlyOwner {
