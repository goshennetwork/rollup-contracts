 ...
 *
 */
contract CanonicalTransactionChain is ICanonicalTransactionChain, AddressResolver {
    /*************
     * Constants *
     *************/
    ...
    OVMCodec.QueueElement[] queueElements;
     ...
     */
    function setGasParams(uint256 _l2GasDiscountDivisor, uint256 _enqueueGasCost) external onlyBurnAdmin {
        enqueueGasCost = _enqueueGasCost;
        l2GasDiscountDivisor = _l2GasDiscountDivisor;
     ...
     */
    // slither-disable-next-line external-function
    function getQueueElement(uint256 _index) public view returns (OVMCodec.QueueElement memory _element) {
    ...
    function appendSequencerBatch() external {
        ...
        if (curContext.numSubsequentQueueTransactions == 0) {
            ...
            OVMCodec.QueueElement memory lastElement = queueElements[nextQueueIndex - 1];
    ...
    function _appendBatch(
        ...
        OVMCodec.ChainBatchHeader memory header = OVMCodec.ChainBatchHeader({
        ...
        bytes32 batchHeaderHash = OVMCodec.hashBatchHeader(header);
