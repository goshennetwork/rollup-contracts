...
interface IMachineState {
    ...
    function writeMemory(bytes32 root, uint32 ptr, uint32 value) external returns (bytes32);

    function writeMemoryBytes4(bytes32 root, uint32 ptr, bytes4 value) external returns (bytes32);

    function writeMemoryByte(bytes32 root, uint32 ptr, bytes1 value) external returns (bytes32);

    function writeMemoryBytes2(bytes32 root, uint32 ptr, bytes2 value) external returns (bytes32);

    function writeMemoryBytes32(bytes32 root, uint32 ptr, bytes32 val) external returns (bytes32);

    function writeMemoryAddr(bytes32 root, uint32 ptr, address val) external returns (bytes32);
    ...
    function writeRegisterBytes4(bytes32 root, uint32 regid, bytes4 value) external returns (bytes32);

    function writeRegister(bytes32 root, uint32 regid, uint32 value) external returns (bytes32);
    ...
    function readMemoryString(bytes32 _root, uint32 addr, uint32 len) external view returns (string memory);
