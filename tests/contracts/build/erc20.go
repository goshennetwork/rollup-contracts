...
func DeployERC20(provider *jsonrpc.Client, from web3.Address, args ...interface{}) *contract.Txn {
	return contract.DeployContract(provider, from, abiERC20, binERC20, args...)
}
...
func (_a *ERC20) Transfer(recipient web3.Address, amount *big.Int) *contract.Txn {
	return _a.c.Txn("transfer", recipient, amount)
}

// TransferFrom sends a transferFrom transaction in the solidity contract
func (_a *ERC20) TransferFrom(sender web3.Address, recipient web3.Address, amount *big.Int) *contract.Txn {
	return _a.c.Txn("transferFrom", sender, recipient, amount)
}
